...
export const ELIGIBILITY_QUESTIONS: IntakeQuestion[] = [
  ...
  },
  {
    ...
    choices: [
      ...
      { value: 'FROM_40K_TO_64K', text: '$40,000 - $64,000' },
      { value: 'FROM_65K_TO_89K', text: '$65,000 - $89,000' },
      { value: 'FROM_90K_TO_114K', text: '$90,000 - $114,000' },
      { value: 'FROM_115K_TO_139K', text: '$115,000 - $139,000' },
      { value: 'FROM_140K_TO_155K', text: '$140,000 - $155,000' },
      { value: 'OVER_155K', text: 'Over $155,000' },
    ],
    title: 'Is your household annual income roughly within these ranges?',
  },
  {
