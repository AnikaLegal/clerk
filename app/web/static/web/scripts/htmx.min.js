(function (e, t) {
  ...
  return (function () {
    ...
    function j(e, t, r) {
      if (s(t)) {
        return { target: M().body, event: e, listener: t };
      } else {
    ...
    function J(e, t, r) {
      ...
      if (o) {
        ...
        ot(M().body, "htmx:oobErrorNoTarget", { content: t });
      }
      return e;
    }
    function Z(e, r) {
          ...
          if (a === "]") {
            ...
            if (n === 0) {
              ...
              try {
                ...
                ot(M().body, "htmx:syntax:error", { error: e, source: i });
                return null;
              }
            }
          } else if (a === "[") {
    ...
    function ht(e, t, r, n) {
      ...
      while (i.length > 0) {
        try {
          ...
          ot(M().body, "htmx:historyCacheError", { cause: e, cache: i });
          i.shift();
        }
      }
    }
    ...
    function gt() {
      ...
      if (v.config.historyEnabled)
        history.replaceState({ htmx: true }, M().title, window.location.href);
    ...
    function yt(n) {
      ...
      e.onload = function () {
        if (this.status >= 200 && this.status < 400) {
          ...
          ot(M().body, "htmx:historyCacheMissLoadError", i);
        }
      };
      e.send();
    }
    ...
    function Dt(t, r, n) {
      ...
      if (i != null) {
        ...
        if (k(r, "hx-encoding") === "multipart/form-data") {
          return Ht(n);
        } else {
          return qt(n);
        }
    ...
    function $t(e, t, r) {
      if (r) {
        if (r instanceof Element || o(r, "String")) {
          return Jt(e, t, null, null, { targetOverride: N(r) });
        } else {
          return Jt(e, t, N(r.source), r.event, {
            handler: r.handler,
            headers: r.headers,
            values: r.values,
    ...
    function Jt(e, t, r, n, i) {
      ...
      if (h) {
        var d = prompt(h);
        if (d === null || !lt(r, "htmx:prompt", { prompt: d, target: l })) D(o);
        c();
        return s;
      }
      ...
      g.onload = function () {
        try {
          ...
          ot(r, "htmx:onLoadError", U({ error: e }, H));
          throw e;
        } finally {
          Et(N);
          var e = r;
          ...
          lt(e, "htmx:afterRequest", H);
          lt(e, "htmx:afterOnLoad", H);
          D(o);
          c();
        }
      };
      g.onerror = function () {
        ...
        ot(e, "htmx:afterRequest", H);
        ot(e, "htmx:sendError", H);
        D(a);
        c();
      };
      g.onabort = function () {
        ...
        ot(e, "htmx:afterRequest", H);
        ot(e, "htmx:sendAbort", H);
        D(a);
        c();
      };
      if (!lt(r, "htmx:beforeRequest", H)) {
        D(o);
        c();
        return s;
      }
        ...
        if (u.status !== 204) {
          ...
          var e = function () {
            try {
              ...
              if (Bt(u, /HX-Trigger-After-Swap:/i)) {
                var i = a;
                if (!P(a)) {
                  i = M().body;
                }
              ...
              var o = function () {
                ...
                if (c) {
                  var e =
                    ...
                    s.pathInfo.path;
                  pt(e);
                  lt(M().body, "htmx:pushedIntoHistory", { path: e });
                }
                Xt(r.elts, d);
                if (Bt(u, /HX-Trigger-After-Settle:/i)) {
                  var t = a;
                  if (!P(a)) {
                    t = M().body;
                  }
