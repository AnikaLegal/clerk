...
class IncomeRange(models.TextChoices):
    ...
    FROM_40K_TO_64K = "FROM_40K_TO_64K", "$40,000 - $64,999"
    FROM_65K_TO_89K = "FROM_65K_TO_89K", "$65,000 - $89,999"
    FROM_90K_TO_114K = "FROM_90K_TO_114K", "$90,000 - $114,999"
    FROM_115K_TO_139K = "FROM_115K_TO_139K", "$115,000 - $139,999"
