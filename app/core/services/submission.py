    ...
    try:
        with transaction.atomic():
            ...
            try:
                ...
                client, _ = Client.objects.get_or_create(
                    ...
                    defaults={
                        ...
                        "primary_language_non_english": answers[
                        ...
                        "legal_access_difficulties": answers.get(
                            "LEGAL_ACCESS_DIFFICULTIES"
                        )
                        or [],
                        "is_multi_income_household": answers[
            ...
            try:
                ...
                FileUpload.objects.filter(pk__in=issue_upload_ids).update(
                    issue=issue.pk
                )
                logger.info(
