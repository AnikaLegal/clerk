...
REPAIRS_ISSUE = {
    ...
    "answers": {
        "REQUIRED": ["Water", "Roof"],
        "ISSUE_DESCRIPTION": "Water pipe burst, damaging roof.",
        "ISSUE_START": "2020-01-01",
    },
}
...
EVICTIONS_ANSWERS = {
    ...
    "EVICTION_ARREARS_IS_UNPAID_RENT": True,
    "EVICTION_ARREARS_IS_ALREADY_REMOVED": False,
    "EVICTION_ARREARS_HAS_NOTICE": True,
    "EVICTION_ARREARS_DOCUMENTS_PROVIDED": [
        "Notice to Vacate",
        "Application for a Possession Order",
    ],
    "EVICTION_ARREARS_DOCUMENTS_UPLOAD": [
        {
    ...
    "EVICTION_ARREARS_NOTICE_SEND_DATE": "1990-02-01",
    ...
    "EVICTION_ARREARS_RENT_CYCLE": "FORTNIGHTLY",
    "EVICTION_ARREARS_IS_ON_PAYMENT_PLAN": False,
    "EVICTION_ARREARS_CAN_AFFORD_PAYMENT_PLAN": "YES",
    "EVICTION_ARREARS_PAYMENT_AMOUNT": 200,
    "EVICTION_ARREARS_PAYMENT_FAIL_REASON": [
        "Unable to work",
        "Another tenant moving out",
    ],
    "EVICTION_ARREARS_PAYMENT_FAIL_DESCRIPTION": "Got fired and friend moving in with parents",
    "EVICTION_ARREARS_PAYMENT_FAIL_CHANGE": "Got a new job",
    "EVICTION_ARREARS_MISC": "Landlord harasses me with phone calls",
}
EVICTIONS_ISSUE = {
    "client": "Matthew",
    ...
    "answers": {
        "IS_UNPAID_RENT": True,
        "IS_ALREADY_REMOVED": False,
        "HAS_NOTICE": True,
        "DOCUMENTS_PROVIDED": [
            "Notice to Vacate",
            "Application for a Possession Order",
        ],
        "NOTICE_SEND_DATE": "1990-02-01",
        ...
        "RENT_UNPAID": 11000,
        "RENT_CYCLE": "FORTNIGHTLY",
        "IS_ON_PAYMENT_PLAN": False,
        "CAN_AFFORD_PAYMENT_PLAN": "YES",
        "PAYMENT_AMOUNT": 200,
        "PAYMENT_FAIL_REASON": [
            "Unable to work",
            "Another tenant moving out",
        ],
        "PAYMENT_FAIL_DESCRIPTION": "Got fired and friend moving in with parents",
        "PAYMENT_FAIL_CHANGE": "Got a new job",
        "MISC": "Landlord harasses me with phone calls",
    },
}
EVICTIONS_UPLOADS = [
...
BONDS_ISSUE = {
    ...
    "answers": {
        ...
        "MOVE_OUT_DATE": "1990-01-01",
        "LOCKS_CLAIM_AMOUNT": 123,
        "DAMAGE_CLAIM_AMOUNT": 234,
        "OTHER_REASONS_AMOUNT": 345,
        "CLEANING_CLAIM_AMOUNT": 456,
        "MONEY_OWED_CLAIM_AMOUNT": 567,
        "DAMAGE_CAUSED_BY_TENANT": True,
        "LOCKS_CHANGED_BY_TENANT": True,
        "MONEY_IS_OWED_BY_TENANT": True,
        "OTHER_REASONS_DESCRIPTION": "bad breath",
        "CLEANING_CLAIM_DESCRIPTION": "real dirty",
        "MONEY_OWED_CLAIM_DESCRIPTION": "stole my car",
        "DAMAGE_CLAIM_DESCRIPTION": "broke the toilet",
        "LANDLORD_INTENTS_TO_MAKE_CLAIM": True,
        "TENANT_HAS_RTBA_APPLICATION_COPY": True,
        "HAS_LANDLORD_MADE_RTBA_APPLICATION": True,
    },
}
BONDS_UPLOADS = [
