# Generated by Django 5.1.1 on 2025-03-31 01:06

import django.db.models.deletion
import django.utils.timezone
import task.auditlog.log_data_mixin
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            bases=(models.Model, task.auditlog.log_data_mixin.LogDataMixin),
        ),
        migrations.CreateModel(
            name="TaskComment",
            fields=[
                ...
                (
                    ...
                    models.TextField(
                        choices=[
                            ...
                            ("REASSIGNED_CASE", "Case Reassigned"),
                            ("REASSIGNED_TASK", "Task Reassigned"),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("type", models.TextField(choices=[("APPROVAL", "Approval request")])),
                (
                    "status",
                    models.TextField(
