...
!function () {
      ...
      for (a = 0; (c = o.exec(e)); )
        if (p.test(c[0])) a++ || (s = (n = o.lastIndex) - c[0].length);
          ...
          var l = c.index + c[0].length,
            c = {
              left: { start: s, end: n },
              match: { start: n, end: c.index },
              right: { start: c.index, end: l },
  ...
  function s(u) {
    ...
    return function (e, r, t, a, c, n, s) {
      ...
      return (
        ...
        u.excludeTrailingPunctuationFromURLs && n && (i = n),
        r +
          '<a href="' +
          t +
          '"' +
          (l = u.openLinksInNewWindow
  ...
  x.subParser("autoLinks", function (e, r, t) {
      ...
      function l(e, r, t, a, n, s, u, o) {
        ...
        if (
          ...
          if (
            ...
            x.helper.isUndefined(i[t]))
          )
            return e;
          (a = i[t]),
            x.helper.isUndefined(l[t]) || (o = l[t]),
            x.helper.isUndefined(c[t]) || ((n = c[t].width), (s = c[t].height));
        }
        r = r
          .replace(/"/g, "&quot;")
          .replace(
    ...
    x.subParser("paragraphs", function (e, r, t) {
      "use strict";
      for (
        var u = (e = (e = (e = t.converter._dispatch(
            "paragraphs.before",
            e,
            r,
            t
        ...
        0 <= o.search(/¨(K|G)(\d+)\1/g)
          ? a.push(o)
          : 0 <= o.search(/\S/) &&
            ((o = (o = x.subParser("spanGamut")(o, r, t)).replace(
              /^([ \t]*)/g,
              "<p>"
            )),
            (o += "</p>"),
      ...
      for (n = a.length, s = 0; s < n; s++) {
        for (var i = "", l = a[s], d = !1; /¨(K|G)(\d+)\1/.test(l); ) {
          var p = RegExp.$1,
            c = RegExp.$2;
          (i = (i =
            "K" === p
              ? t.gHtmlBlocks[c]
              : d
              ? x.subParser("encodeCode")(t.ghCodeBlocks[c].text, r, t)
              : t.ghCodeBlocks[c].codeblock).replace(/\$/g, "$$$$")),
            (l = l.replace(/(\n\n)?¨(K|G)\d+\2(\n\n)?/, i)),
    ...
    x.subParser("tables", function (e, y, P) {
      ...
      function r(u) {
        for (var e = u.split("\n"), r = 0; r < e.length; ++r)
          /^ {0,3}\|/.test(e[r]) && (e[r] = e[r].replace(/^ {0,3}\|/, "")),
            /\|[ \t]*$/.test(e[r]) && (e[r] = e[r].replace(/\|[ \t]*$/, "")),
            (e[r] = x.subParser("codeSpans")(e[r], y, P));
        var t,
          a,
          d,
          n,
          p,
          h = e[0].split("|").map(function (e) {
            return e.trim();
          }),
          ...
          o = [],
          m = [];
        for (e.shift(), e.shift(), r = 0; r < e.length; ++r)
          "" !== e[r].trim() &&
            s.push(
              e[r].split("|").map(function (e) {
                return e.trim();
              })
            );
          ...
          x.helper.isUndefined(o[r]) && (o[r] = ""),
            g.push(
              ...
              "<th" +
                ...
                d +
                ">" +
                (a = x.subParser("spanGamut")(a, y, P)) +
                "</th>\n")
            );
        for (r = 0; r < s.length; ++r) {
          for (var f = [], i = 0; i < g.length; ++i)
            x.helper.isUndefined(s[r][i]),
              f.push(
                ((p = s[r][i]),
                "<td" +
                  o[i] +
                  ">" +
                  x.subParser("spanGamut")(p, y, P) +
                  "</td>\n")
              );
          m.push(f);
        }
    ...
    x.subParser("makeMarkdown.table", function (e, r) {
      ...
      for (o = 0; o < s.length; ++o)
        for (
          var d = a.push([]) - 1, p = s[o].getElementsByTagName("td"), l = 0;
          l < n.length;
          ++l
        ) {
          var h = " ";
          void 0 !== p[l] &&
            (h = x.subParser("makeMarkdown.tableCell")(p[l], r)),
            a[d].push(h);
        }
      var c = 3;
      ...
      for (o = 0; o < a.length; ++o) {
        for (l = 0; l < a[o].length; ++l)
          1 === o
            ? ":" === a[o][l].slice(-1)
              ? (a[o][l] = x.helper.padEnd(a[o][l].slice(-1), c - 1, "-") + ":")
              : (a[o][l] = x.helper.padEnd(a[o][l], c, "-"))
            : (a[o][l] = x.helper.padEnd(a[o][l], c));
        t += "| " + a[o].join(" | ") + " |\n";
      }
      return t.trim();
