...
!(function (p, h, v, b) {
              ...
              setting: function (o, a, e, r) {
                (e =
                  ...
                  p.each(e, function (e, t) {
                    var n,
                      i =
                        !s.moduleExists(t) || p.fn[t].settings.namespace || !1;
                    s.moduleExists(t) &&
                  ...
                  p.each(i, function (e, t) {
                    ...
                    if (p.isPlainObject(r[n]) && e != o) r = r[n];
                      ...
                      if (!p.isPlainObject(r[t]) || e == o)
                        return (
                          r[t] !== b ? (a = r[t]) : s.error(d.method, i), !1
                        );
                      r = r[t];
                    }
                  })),
            ...
            (v = {
              ...
              bindEvents: function () {
                v.verbose("Attaching form events"),
                  ...
                  g.preventLeaving &&
                    M(I).on("beforeunload" + s, v.event.beforeUnload),
                ...
                n.each(function (e, t) {
                  ...
                  s !== L &&
                    ...
                    c
                      ...
                      : l
                      ? (v.verbose("Resetting checkbox value", i, s),
                        n.prop("checked", s))
                      : u
                ...
                field: {
                  keydown: function (e) {
                    var t = M(this),
                      ...
                      r = 13;
                    n == 27 &&
                      (v.verbose("Escape key pressed blurring field"),
                      t.blur()),
                      e.ctrlKey ||
                        n != r ||
                        !i ||
                  ...
                  blur: function (e) {
                    ...
                    n.hasClass(h.error)
                      ? (v.debug("Revalidating field", t, i),
                        i && v.validate.field(i))
                      : "blur" == g.on && i && v.validate.field(i);
                  },
                  change: function (e) {
                    var t = M(this),
                      n = t.closest(f),
                    ...
                    i &&
                      ("change" == g.on ||
                        (n.hasClass(h.error) && g.revalidate)) &&
                      (clearTimeout(v.timer),
                      (v.timer = setTimeout(function () {
                        v.debug("Revalidating field", t, v.get.validation(t)),
                          v.validate.field(i),
              ...
              get: {
                ...
                prompt: function (e, t) {
                  var n,
                    ...
                    s = r.val(),
                    l = M.isFunction(e.prompt)
                      ? e.prompt(s)
                      : e.prompt || g.prompt[o] || g.text.unspecifiedRule,
                    c = -1 !== l.search("{value}"),
                    u = -1 !== l.search("{name}");
                  return (
                    c && (l = l.replace(/\{value\}/g, r.val())),
                    u &&
                      ((i =
                        1 == (n = r.closest(p.group).find("label").eq(0)).length
                          ? n.text()
                          : r.prop("placeholder") || g.text.unspecifiedField),
                ...
                settings: function () {
                  if (M.isPlainObject(k)) {
                    ...
                    k[e[0]].rules !== L
                      ...
                      : (k.fields &&
                          v.is.shorthandFields(k.fields) &&
                          (k.fields = v.get.fieldsFromShorthand(k.fields)),
                        (g = M.extend(!0, {}, M.fn.form.settings, k)),
                        (l = M.extend(
                          {},
                          M.fn.form.settings.defaults,
                          g.fields
                        )),
                            ...
                            if ("date" == g.dateHandling) m[o] = d;
                              ...
                              switch (f) {
                                ...
                                case "year":
                                  ...
                                  break;
                                default:
                                  v.debug("Wrong calendar mode", i, f),
                                    (m[o] = "");
                              }
                            }
                          } else m[o] = "";
                ...
                field: function (e) {
                  return (
                    ...
                    0 < n.filter("#" + e).length ||
                      ...
                      0 <
                        n.filter("[data-" + m.validate + '="' + e + '"]').length
                  );
                },
              },
              can: {
                useElement: function (e) {
                  return (
                    M.fn[e] !== L ||
                    (v.error(u.noElement.replace("{element}", e)), !1)
                  );
                },
              },
              escape: {
              ...
              add: {
                ...
                fields: function (e) {
                  var t;
                  (t =
                    e && v.is.shorthandFields(e)
                      ? v.get.fieldsFromShorthand(e)
                      : e),
                    (l = M.extend({}, l, t));
                },
                  ...
                  if (l[n] !== L && Array.isArray(l[n].rules))
                    return e === L
                      ...
                      : void M.each(l[n].rules, function (e, t) {
                          t &&
                            -1 !== i.indexOf(t.type) &&
                            (v.debug("Removed rule", t.type),
                            l[n].rules.splice(e, 1));
                        });
                },
                field: function (e) {
              ...
              set: {
                ...
                defaults: function () {
                  n.each(function (e, t) {
                    ...
                    a
                      ? i.dropdown("save defaults")
                      : s && r.calendar("refresh"),
              ...
              validate: {
                ...
                field: function (i, e, o) {
                  ...
                  return (
                    i.identifier ||
                      (v.debug("Using field name as identifier", a),
                      (i.identifier = a)),
                    ...
                    k.each(i, function (e, t) {
                      ...
                      if (k.isPlainObject(r[n]) && e != o) r = r[n];
                        ...
                        if (!k.isPlainObject(r[t]) || e == o)
                          return (
                            r[t] !== S ? (a = r[t]) : c.error(s.method, i), !1
                          );
                        r = r[t];
                      }
                    })),
        ...
        return (
          e.each(function () {
            ...
            (le = {
              ...
              instantiate: function () {
                le.verbose("Storing instance of calendar"),
                  (m = le),
                  l.data(o, m);
              },
              destroy: function () {
              ...
              setup: {
                config: function () {
                  null !== le.get.minDate() &&
                    le.set.minDate(l.data(fe.minDate)),
                    null !== le.get.maxDate() &&
                      le.set.maxDate(l.data(fe.maxDate)),
                ...
                popup: function () {
                  if (
                    !ce.inline &&
                    (u.length || (u = l.children().first()).length)
                  )
                    if (ve.fn.popup !== be) {
                      if (!ge.length) {
                        var e = u.parent(),
                          t =
                            0 !== e.closest(r.append).length
                              ? "appendTo"
                              : "prependTo";
                    ...
                    if (!v) {
                      ...
                      if ((Q.data(fe.mode, X), 0 === i)) {
                        ...
                        $.data(fe.focusDate, q),
                          $.toggleClass(
                            ue.disabledCell,
                            !le.helper.isDateInRange(z, s)
                          ),
                          ve("<i/>").addClass(ue.prevIcon).appendTo($);
                      }
                      if (i === A - 1) {
                        var G = ve("<span/>").addClass(ue.next).appendTo(a);
                        G.data(fe.focusDate, V),
                          G.toggleClass(
                            ue.disabledCell,
                            !le.helper.isDateInRange(N, s)
                          ),
                          ve("<i/>").addClass(ue.nextIcon).appendTo(G);
                      }
                      if (g)
                        for (
                          o = ve("<tr/>").appendTo(W),
                    ...
                    for (
                      ...
                      for (
                        ...
                        if (ee) {
                          ...
                          null !== te &&
                            te[fe.message] &&
                            (a.attr("data-tooltip", te[fe.message]),
                            a.attr("data-position", te[fe.position] || F),
                            (te[fe.inverted] ||
                              (pe && te[fe.inverted] === be)) &&
                              a.attr("data-inverted", ""),
                            te[fe.variation] &&
                              a.attr("data-variation", te[fe.variation]));
                        } else {
                          var ne = le.helper.findDayAsObject(
                            J,
                            s,
                            ce.eventDates
                          );
                          null !== ne &&
                            (a.addClass(ne[fe.class] || ce.eventClass),
                            ne[fe.message] &&
                              (a.attr("data-tooltip", ne[fe.message]),
                              a.attr("data-position", ne[fe.position] || F),
                              (ne[fe.inverted] ||
                                (pe && ne[fe.inverted] === be)) &&
                                a.attr("data-inverted", ""),
                              ne[fe.variation] &&
                                a.attr("data-variation", ne[fe.variation])));
                        }
                        var ie = le.helper.dateEqual(J, c, s),
                          oe = le.helper.dateEqual(J, l, s);
                        a.toggleClass(ue.adjacentCell, _),
                          a.toggleClass(ue.disabledCell, ee),
                          a.toggleClass(ue.activeCell, ie && !_),
                          p || h || a.toggleClass(ue.todayCell, !_ && oe);
                        var ae = {
                          mode: s,
                          adjacent: _,
                          disabled: ee,
                        ...
                        de.cell(a, J, ae),
                          le.helper.dateEqual(J, u, s) &&
                            le.set.focusDate(J, !1, !1);
                      }
                    if (ce.today) {
              ...
              refreshTooltips: function () {
                ...
                ge.find("td[data-position]").each(function () {
                  var e = ve(this),
                    t = S.getComputedStyle(e[0], ":after").width.replace(
                      /[^0-9\.]/g,
                      ""
                    ),
              ...
              event: {
                ...
                mousedown: function (e) {
                  c.length && e.preventDefault(),
                    (g = 0 <= e.type.indexOf("touch"));
                  var t = ve(e.target).data(fe.date);
                ...
                keydown: function (e) {
                  ...
                  (38 !== t && 40 !== t) ||
                    (e.preventDefault(), le.popup("show"));
                },
              ...
              get: {
                ...
                calendarModule: function (e) {
                  return e
                    ? (e instanceof ve || (e = ve(e).first()), e.data(o))
                    : null;
                },
              },
              set: {
                ...
                minDate: function (e) {
                  (e = le.helper.sanitiseDate(e)),
                    null !== ce.maxDate && ce.maxDate <= e
                      ...
                      : (le.setting("minDate", e),
                        le.set.dataKeyValue(fe.minDate, e));
                },
                maxDate: function (e) {
                  (e = le.helper.sanitiseDate(e)),
                    null !== ce.minDate && ce.minDate >= e
                      ...
                      : (le.setting("maxDate", e),
                        le.set.dataKeyValue(fe.maxDate, e));
                },
              ...
              selectDate: function (e, t) {
                ...
                if (
                  ...
                  if (!(!1 === le.set.date(e)) && ((a = !0), ce.closable)) {
                    ...
                    i &&
                      ("focus" !== i.setting("on") && i.popup("show"),
                      i.focus());
                  }
                } else {
                  var o =
              ...
              helper: {
                isDisabled: function (n, i) {
                  return (
                    ...
                    (-1 !== ce.disabledDaysOfWeek.indexOf(n.getDay()) ||
                  ...
                  if ("day" === n || "month" === n || "year" === n)
                    for (var i, o = 0; o < e.length; o++) {
                      ...
                      if (null !== i && "object" == typeof i)
                        if (i[fe.year]) {
                          if (
                            "number" == typeof i[fe.year] &&
                            t.getFullYear() == i[fe.year]
                          )
                            return i;
                          if (
                          ...
                          if (
                            "number" == typeof i[fe.month] &&
                            t.getMonth() == i[fe.month]
                          )
                            return i;
                          if (Array.isArray(i[fe.month])) {
                            if (-1 < i[fe.month].indexOf(t.getMonth()))
                              return i;
                          ...
                          if (
                            ...
                            le.helper.dateEqual(
                              t,
                              le.helper.sanitiseDate(i[fe.date]),
                              n
                            )
                          )
                            return i;
                ...
                dateDiff: function (e, t, n) {
                  ...
                  return (
                    (e = new Date(
                      ...
                      r
                        ? ce.minTimeGap *
                          Math.floor(e.getMinutes() / ce.minTimeGap)
                        : 0
                    )),
                    (t = new Date(
                      i ? 2e3 : t.getFullYear(),
                      ...
                      r
                        ? ce.minTimeGap *
                          Math.floor(t.getMinutes() / ce.minTimeGap)
                        : 0
                    )).getTime() - e.getTime()
                  );
                },
                  ...
                  return (
                    (n =
                      ...
                      new Date(
                        ...
                        n.getHours(),
                        ce.minTimeGap *
                          Math.ceil(n.getMinutes() / ce.minTimeGap)
                      )),
                    !(
                      !e ||
              ...
              performance: {
                log: function (e) {
                  ...
                  ce.performance &&
                    ...
                    (le.performance.timer = setTimeout(
                      le.performance.display,
                      500
                    ));
                },
                display: function () {
                    ...
                    ve.each(i, function (e, t) {
                      ...
                      if (ve.isPlainObject(r[n]) && e != o) r = r[n];
                        ...
                        if (!ve.isPlainObject(r[t]) || e == o)
                          return (
                            r[t] !== be ? (a = r[t]) : le.error(s.method, i), !1
                          );
                        r = r[t];
                      }
                    })),
      ...
      (ve.fn.calendar.settings = {
        ...
        parser: {
          date: function (e, t) {
            ...
            e.match(/^[0-9]{4}[\/\-\.][0-9]{2}[\/\-\.][0-9]{2}$/) &&
              (e = e.replace(/[\/\-\.]/g, "/") + " 00:00:00"),
              (e =
                t.monthFirst || !e.match(/^[0-9]{2}[\/\-\.]/)
                  ? e
                  : e
                      .replace(/[\/\-\.]/g, "/")
                      .replace(/([0-9]+)\/([0-9]+)/, "$2/$1"));
            var n,
              ...
              o,
              a = new Date(e);
            if (!(null !== e.match(/^[0-9]+$/)) && !isNaN(a.getDate()))
              return a;
            e = e.toLowerCase();
            var r,
              s,
              ...
              for (n = 0; n < v.length; n++)
                if (!((r = v[n]).length <= 0)) {
                  for (i = 0; i < t.text.months.length; i++)
                    if (
                      t.text.months[i].substring(0, r.length).toLowerCase() ===
                      r
                    ) {
                      f = i + 1;
                      break;
        ...
        return (
          e.each(function () {
            ...
            (m = {
              ...
              refresh: function () {
                (a = h.children(p.label)),
                  (v = h.children(p.input)),
                  (b = v[0]);
              },
              hide: {
                input: function () {
              ...
              event: {
                ...
                keydown: function (e) {
                  ...
                  if (
                    ...
                    if (
                      !1 === g.beforeChecked.apply(S(c[f]).children(p.input)[0])
                    )
                      return (
                        m.verbose(
              ...
              is: {
                ...
                indeterminate: function () {
                  return (
                    v.prop("indeterminate") !== E && v.prop("indeterminate")
                  );
                },
                checked: function () {
                    ...
                    S.each(i, function (e, t) {
                      ...
                      if (S.isPlainObject(r[n]) && e != o) r = r[n];
                        ...
                        if (!S.isPlainObject(r[t]) || e == o)
                          return (
                            r[t] !== E ? (a = r[t]) : m.error(s.method, i), !1
                          );
                        r = r[t];
                      }
                    })),
            ...
            (s = {
              ...
              bind: {
                events: function () {
                  "hover" == a.on
                    ? t
                        .on("mouseenter" + r, s.show)
                        .on("mouseleave" + r, s.hide)
              ...
              get: {
                ...
                duration: function () {
                  return "object" == typeof a.duration
                    ? s.is.active()
                      ? a.duration.hide
                      : a.duration.show
                    : a.duration;
                  ...
                  "string" == typeof i &&
                    ...
                    k.each(i, function (e, t) {
                      ...
                      if (k.isPlainObject(r[n]) && e != o) r = r[n];
                        ...
                        if (!k.isPlainObject(r[t]) || e == o)
                          return (
                            r[t] !== S ? (a = r[t]) : s.error(l.method, i), !1
                          );
                        r = r[t];
                      }
                    })),
  ...
  (function (ee, te, ne, ie) {
    ...
    (ee.isFunction =
      ...
      (te =
        void 0 !== te && te.Math == Math
          ? te
          : "undefined" != typeof self && self.Math == Math
          ? self
          : Function("return this")()),
      (ee.fn.dropdown = function (U) {
        var B,
          W = ee(this),
          Y = ee(ne),
          Q = W.selector || "",
        ...
        return (
          W.each(function (n) {
            var c,
              ...
              l,
              p,
              g = ee.isPlainObject(U)
                ? ee.extend(!0, {}, ee.fn.dropdown.settings, U)
                : ee.extend({}, ee.fn.dropdown.settings),
              h = g.className,
              u = g.message,
              d = g.fields,
              v = g.keys,
              ...
              R =
                0 < T.prev().find(y.text).length
                  ? T.prev().find(y.text)
                  : T.prev(),
              M = T.children(y.menu),
              I = M.find(y.item),
              j = g.hideDividers ? I.parent().children(y.divider) : ee(),
              L = !1,
              q = !1,
              V = !1,
              z = !1,
            ...
            (p = {
              ...
              instantiate: function () {
                p.verbose("Storing instance of dropdown", p),
                  (H = p),
                  T.data(k, p);
              },
              destroy: function () {
              ...
              observe: {
                ...
                menu: function () {
                  p.has.menu() &&
                    s &&
                    s.observe(M[0], { childList: !0, subtree: !0 });
                },
                class: function () {
              ...
              search: function (e) {
                (e = e !== ie ? e : p.get.query()),
                  p.verbose("Searching for query", e),
                  p.has.minCharacters(e) ? p.filter(e) : p.hide(null, !0);
              },
              select: {
                ...
                nextAvailable: function (e) {
                  ...
                  0 < t.length
                    ? (p.verbose("Moving selection to", t),
                      t.addClass(h.selected))
                    : (p.verbose("Moving selection to", n),
              ...
              setup: {
                ...
                layout: function () {
                  T.is("select") &&
                    (p.setup.select(), p.setup.returnedObject()),
                    ...
                    0 < F.parent(y.dropdown).length
                      ...
                      : (p.debug("Creating entire dropdown from select"),
                        (T = ee("<div />")
                          ...
                          .addClass(h.dropdown)
                          .html(C.dropdown(e, d, g.preserveHTML, g.className))
                          .insertBefore(F)),
                        ...
                        F.prop("disabled") &&
                          (p.debug("Disabling dropdown"),
                          T.addClass(h.disabled)),
                ...
                menu: function (e) {
                  M.html(C.menu(e, d, g.preserveHTML, g.className)),
                    (I = M.find(y.item)),
                    (j = g.hideDividers
                      ? I.parent().children(y.divider)
                      : ee());
                },
                reference: function () {
                  p.debug(
              ...
              bind: {
                ...
                keyboardEvents: function () {
                  p.verbose("Binding keyboard events"),
                    ...
                    p.is.multiple() &&
                      Y.on("keydown" + o, p.event.document.keydown);
                },
                  ...
                  p.verbose("Binding mouse events"),
                    ...
                    p.is.searchSelection()
                      ? (T.on("mousedown" + w, p.event.mousedown)
                        ...
                        p.is.multiple() && T.on($ + w, p.event.click))
                      : ("click" == g.on
                ...
                intent: function () {
                  p.verbose("Binding hide intent event to document"),
                    X &&
                      Y.on("touchstart" + o, p.event.test.touch).on(
                        "touchmove" + o,
                        p.event.test.touch
                      ),
                    Y.on($ + o, p.event.test.hide);
                },
              },
              unbind: {
                intent: function () {
                  p.verbose("Removing hide intent event from document"),
                    X && Y.off("touchstart" + o).off("touchmove" + o),
                    Y.off($ + o);
                },
              },
              filter: function (e) {
                    ...
                    ? p.can.useAPI()
                      ? p.queryRemote(n, function () {
                          ...
                          Array.isArray(e) ||
                            ...
                            ee.each(e, function (e, t) {
                              I.filter('[data-value="' + t + '"]').addClass(
                                h.filtered
                              );
                            }),
                            t();
              ...
              queryRemote: function (e, i) {
                ...
                T.api("get request") || p.setup.api(),
                  (t = ee.extend(!0, {}, t, g.apiSettings)),
                  T.api("setting", t).api("query");
              },
              filterItems: function (e) {
                var i = p.remove.diacritics(e !== ie ? e : p.get.query()),
                  o = null,
                  t = p.escape.string(i),
                ...
                p.has.query() &&
                  ...
                  I.each(function () {
                    ...
                    if ("both" === g.match || "text" === g.match) {
                      if (
                        -1 !==
                        (e = p.remove.diacritics(
                          String(p.get.choiceText(n, !1))
                        )).search(a)
                      )
                    ...
                    if ("both" === g.match || "value" === g.match) {
                      if (
                        -1 !==
                        (t = p.remove.diacritics(
                          String(p.get.choiceValue(n, e))
                        )).search(a)
                      )
                        return o.push(this), !0;
                ...
                values: function (e) {
                  ...
                  (t[d.values] = e),
                    ...
                    ee.each(e, function (e, t) {
                      if (
                        1 == t.selected &&
                        (p.debug("Setting initial selection to", t[d.value]),
                        p.set.selected(t[d.value]),
                        !p.is.multiple())
                      )
                        return !1;
                    }),
              ...
              event: {
                change: function () {
                  V ||
                    (p.debug("Input changed, updating selection"),
                    p.set.selected());
                },
                focus: function () {
                ...
                input: function (e) {
                  (p.is.multiple() || p.is.searchSelection()) &&
                    p.set.filtered(),
                ...
                menu: {
                  mutation: function (e) {
                    var t = e[0],
                      n = t.addedNodes ? ee(t.addedNodes[0]) : ee(!1),
                      i = t.removedNodes ? ee(t.removedNodes[0]) : ee(!1),
                      o = n.add(i),
                      a = o.is(y.addition) || 0 < o.closest(y.addition).length,
                      r = o.is(y.message) || 0 < o.closest(y.message).length;
                    a || r
                      ? (p.debug("Updating item selector cache"),
                        p.refreshItems())
                      : (p.debug("Menu modified, updating selector cache"),
                        p.refresh());
                  },
                  mousedown: function () {
                    q = !0;
                ...
                item: {
                  ...
                  click: function (e, t) {
                    var n = ee(this),
                      ...
                      s = 0 < o.length,
                      l = 0 < o.find(i).length;
                    "input" !== ne.activeElement.tagName.toLowerCase() &&
                      ee(ne.activeElement).blur(),
                      l ||
                        ...
                        (p.is.searchSelection() &&
                          ...
                          p.is.focusedOnSearch() ||
                            ...
                            p.focusSearch(!0)),
                        g.useLabels ||
                          (p.remove.filteredItem(), p.set.scrollPosition(n)),
                        ...
                        ? (f && !r && n.first().addClass(h.active),
                          r &&
                            (e.shiftKey
                              ...
                              : (p.verbose("Selecting next label"),
                                n.removeClass(h.active)),
                            c
                              ? u
                                ? d
                ...
                keydown: function (e) {
                  ...
                  if (p.is.inObject(t, v)) {
                    var n,
                      ...
                      m =
                        t == v.delimiter && g.allowAdditions && p.is.multiple();
                    if (
                      (g.allowAdditions &&
                        g.hideAdditions &&
                        (t == v.enter || m) &&
                      ...
                      t == v.pageUp && (p.scrollPage("up"), e.preventDefault()),
                        t == v.pageDown &&
                          (p.scrollPage("down"), e.preventDefault()),
                        t == v.escape &&
                          (p.verbose("Escape key pressed, closing dropdown"),
                          p.hide());
                    } else
                      m && e.preventDefault(),
                        t != v.downArrow ||
                    ...
                    p.has.search() ||
                      p.set.selectedLetter(String.fromCharCode(t));
                },
              },
              trigger: {
                change: function () {
              ...
              determine: {
                ...
                eventInModule: function (e, t) {
                  var n = ee(e.target),
                    i = 0 < n.closest(ne.documentElement).length,
                    o = 0 < n.closest(T).length;
                  return (
                    (t = ee.isFunction(t) ? t : function () {}),
                    i && !o
              ...
              action: {
                ...
                activate: function (e, t, n) {
                  (t = t !== ie ? t : e),
                    p.can.activate(ee(n)) &&
                      (p.set.selected(t, ee(n)),
                      p.is.multiple() || p.hideAndClear());
                },
                select: function (e, t, n) {
                  (t = t !== ie ? t : e),
                    p.can.activate(ee(n)) &&
                      (p.set.value(t, e, ee(n)),
                      p.is.multiple() || p.hideAndClear());
                },
              ...
              get: {
                ...
                values: function () {
                  ...
                  return "" === e
                    ...
                    ? "string" == typeof e
                      ? p.escape.htmlEntities(e).split(g.delimiter)
                      : ""
                    : e;
                },
                  ...
                  return (
                    ...
                    !!e &&
                      (e.data(b.value) !== ie
                        ...
                        : "string" == typeof t
                        ? String(
                            g.ignoreSearchCase ? t.toLowerCase() : t
                          ).trim()
                        : String(t))
                  );
                },
                  ...
                  return (
                    T.find("option").each(function () {
                      var e = ee(this),
                        ...
                        o = e.data(b.text) !== ie ? e.data(b.text) : t,
                        a = e.parent("optgroup");
                    ...
                    g.sortSelect
                      ? (!0 === g.sortSelect
                          ...
                          : ee.isFunction(g.sortSelect) && l.sort(g.sortSelect),
                        (r[d.values] = l),
                        p.debug("Retrieved and sorted values from select", r))
                      : ((r[d.values] = l),
                        p.debug("Retrieved values from select", r)),
                    r
                  );
                },
                activeItem: function () {
                      ...
                      I.each(function () {
                        ...
                        if (null !== n && n !== ie)
                          if (a)
                            ...
                            return (
                              p.verbose("Found select item by value", n, i),
                              (r = e),
                              !0
                            );
                      }),
              ...
              check: {
                maxSelections: function (e) {
                  return (
                    !g.maxSelections ||
                    ((e = e !== ie ? e : p.get.selectionCount()) >=
                    g.maxSelections
                      ? (p.debug("Maximum selection count reached"),
                        g.useLabels &&
                          (I.addClass(h.filtered),
                          p.add.message(u.maxSelections)),
                        !0)
              ...
              read: {
                remoteData: function (e) {
                  var t;
                  if (te.Storage !== ie)
                    return (t = sessionStorage.getItem(e)) !== ie && t;
                  p.error(x.noStorage);
                },
              },
              save: {
                defaults: function () {
                  p.save.defaultText(),
                    p.save.placeholderText(),
                    p.save.defaultValue();
                },
                defaultValue: function () {
                  var e = p.get.value();
                  p.verbose("Saving default value as", e),
                    T.data(b.defaultValue, e);
                },
                defaultText: function () {
                  var e = p.get.text();
                  p.verbose("Saving default text as", e),
                    T.data(b.defaultText, e);
                },
                placeholderText: function () {
                  var e;
                  !1 !== g.placeholder &&
              ...
              set: {
                filtered: function () {
                  ...
                  e &&
                    ...
                    A.css("width", a)),
                    o || (n && r)
                      ? (p.verbose("Hiding placeholder text"),
                        D.addClass(h.filtered))
                      : (e && (!n || r)) ||
                        (p.verbose("Showing placeholder text"),
                ...
                selectedLetter: function (e) {
                  ...
                  i &&
                    ((t = n.nextAll(I).eq(0)),
                    p.has.firstLetter(t, e) && (o = t)),
                    o ||
                      I.each(function () {
                        if (p.has.firstLetter(ee(this), e))
                          return (o = ee(this)), !1;
                      }),
                    o &&
                      ...
                      g.selectOnKeydown &&
                        p.is.single() &&
                        p.set.selectedItem(o));
                },
                direction: function (e) {
                  "auto" == g.direction
                    ? (e
                        ? p.is.upward(e) && p.remove.upward(e)
                        : p.remove.upward(),
                      p.can.openDownward(e)
                        ? p.remove.upward(e)
                        : p.set.upward(e),
                      p.is.leftward(e) ||
                        p.can.openRightward(e) ||
                        p.set.leftward(e))
                ...
                value: function (e, t, n, i) {
                  e === ie || "" === e || (Array.isArray(e) && 0 === e.length)
                    ? F.addClass(h.noselection)
                    : F.removeClass(h.noselection);
                        ...
                        ? !o || a
                          ? (g.apiSettings &&
                            ...
                            g.useLabels
                              ...
                              : (p.add.value(n, t, e),
                                p.set.text(p.add.variables(u.count)),
                                p.set.activeItem(e)))
                          : i ||
                            (!g.useLabels && !c) ||
              ...
              add: {
                    ...
                    p.has.label(e)
                      ...
                      : (g.label.variation && i.addClass(g.label.variation),
                        !0 === n
                          ...
                          : (p.debug("Adding selection label", i),
                            i.insertBefore(o)));
                },
                message: function (e) {
                ...
                optionValue: function (e) {
                  ...
                  0 <
                    F.find('option[value="' + p.escape.string(t) + '"]')
                      .length ||
                    (p.disconnect.selectObserver(),
                    p.is.single() &&
                ...
                variables: function (e, t) {
                  ...
                  return (
                    ...
                    r &&
                      ((i = t || p.get.query()), (e = e.replace("{term}", i))),
                    e
                  );
                },
              ...
              remove: {
                  ...
                  (e = p.escape.htmlEntities(e)),
                    p.has.selectInput()
                      ...
                      : (p.verbose("Removing from delimited values", e),
                        (i = (i = p.remove.arrayValue(e, o)).join(
                          g.delimiter
                        ))),
                    !1 === g.fireOnInit && p.is.initialLoad()
                ...
                label: function (e, t) {
                  var n = T.find(y.label).filter(
                    "[data-" +
                      b.value +
                      '="' +
                      p.escape.string(g.ignoreCase ? e.toLowerCase() : e) +
                      '"]'
                  );
                  ...
                  (e = e || T.find(y.label)),
                    ...
                    e.each(function () {
                      ...
                      !1 !== g.onLabelRemove.call(e, t)
                        ? (p.remove.message(),
                          i
                            ? (p.remove.value(n), p.remove.label(n))
                            : p.remove.selected(n))
              ...
              has: {
                ...
                minCharacters: function (e) {
                  return g.minCharacters && !z
                    ? (e = e !== ie ? String(e) : String(p.get.query()))
                ...
                label: function (e) {
                  ...
                  return (
                    ...
                    0 <
                      n.filter(
                        "[data-" + b.value + '="' + p.escape.string(t) + '"]'
                      ).length
                  );
                },
                maxSelections: function () {
                  return (
                    g.maxSelections && p.get.selectionCount() >= g.maxSelections
                  );
                },
              ...
              is: {
                ...
                bubbledLabelClick: function (e) {
                  return (
                    ee(e.target).is("select, input") &&
                    0 < T.closest("label").length
                  );
                },
                ...
                selectMutation: function (e) {
                  ...
                  return (
                    ee.each(e, function (e, t) {
                      if (
                        ee(t.target).is("select") ||
                        ee(t.addedNodes).is("select")
                      )
                        return !(n = !0);
                    }),
                    n
                ...
                openDownward: function (e) {
                  ...
                  return (
                    ...
                    (n = {
                      context: {
                        offset:
                          S.get(0) === te ? { top: 0, left: 0 } : S.offset(),
                    ...
                    (o = (t = {
                      ...
                      ? (p.verbose("Dropdown can fit in context downward", t),
                        !0)
                      : t.below || t.above
                      ? (p.verbose(
                ...
                openRightward: function (e) {
                  ...
                  return (
                    ...
                    (t =
                      ...
                      (p.verbose("Dropdown cannot fit in context rightward", t),
                      (o = !1)),
                    i.removeClass(h.loading),
                    o
                  );
              ...
              animate: {
                show: function (e, t) {
                  ...
                  if (
                    ...
                    p.is.selection() &&
                      p.set.scrollPosition(p.get.selectedItem(), !0),
                    p.is.hidden(i) || p.is.animating(i))
                  ) {
                    var a = !!T.hasClass("column") && "flex";
                    "none" == n
                      ? (o(),
                        i.transition({ displayType: a }).transition("show"),
                        e.call(N))
                      : ee.fn.transition !== ie && T.transition("is supported")
                      ? i.transition({
                          animation: n + " in",
                          debug: g.debug,
                          verbose: g.verbose,
              ...
              setting: function (e, t) {
                if ((p.debug("Changing setting", e, t), ee.isPlainObject(e)))
                  ee.extend(!0, g, e);
                else {
                  if (t === ie) return g[e];
              ...
              internal: function (e, t) {
                if (ee.isPlainObject(e)) ee.extend(!0, p, e);
                else {
                  if (t === ie) return p[e];
                  p[e] = t;
                }
              ...
              performance: {
                ...
                display: function () {
                  ...
                  (G = !1),
                    clearTimeout(p.performance.timer),
                    ee.each(K, function (e, t) {
                      n += t["Execution Time"];
                    }),
                    (e += " " + n + "ms"),
                    Q && (e += " '" + Q + "'"),
                    (console.group !== ie || console.table !== ie) &&
                      0 < K.length &&
                      (console.groupCollapsed(e),
                      console.table
                        ? console.table(K)
                      ...
                      var n =
                        e != o
                          ? t +
                            ...
                            i[e + 1].slice(1)
                          : i;
                      if (ee.isPlainObject(r[n]) && e != o) r = r[n];
                      else {
                        if (r[n] !== ie) return (a = r[n]), !1;
                        if (!ee.isPlainObject(r[t]) || e == o)
                          return (
                            r[t] !== ie ? (a = r[t]) : p.error(x.method, i), !1
                          );
                        r = r[t];
                      }
                    })),
                  ee.isFunction(a) ? (n = a.apply(t, e)) : a !== ie && (n = a),
                  Array.isArray(B)
                    ? B.push(n)
                    : B !== ie
                    ? (B = [B, n])
              ...
              Z
                ? (H === ie && p.initialize(), p.invoke(J))
                : (H !== ie && H.invoke("destroy"), p.initialize());
          }),
          B !== ie ? B : W
        );
      }),
      ...
      (ee.fn.dropdown.settings.templates = {
        ...
        dropdown: function (e, t, n, i) {
          ...
          return (
            ...
            (a += o
              ...
              : '<div class="text"></div>'),
            (a += '<div class="' + i.menu + '">'),
            (a += ee.fn.dropdown.settings.templates.menu(e, t, n, i)),
            (a += "</div>")
          );
        },
        menu: function (e, s, l, c) {
          var t = e[s.values] || [],
            u = "",
            d = ee.fn.dropdown.settings.templates.escape,
              ...
              if ("item" === n) {
                ...
                (u +=
                  ...
                  t[s.image] &&
                    (u +=
                      '<img class="' +
                      (t[s.imageClass] ? f(t[s.imageClass]) : c.image) +
                      '" src="' +
                      f(t[s.image]) +
                      '">'),
                  t[s.icon] &&
                    (u +=
                      ...
                      f(t[s.icon]) +
                      " " +
                      (t[s.iconClass] ? f(t[s.iconClass]) : c.icon) +
                      '"></i>'),
                  (u += d(t[s.name] || "", l)),
                  (u += "</div>");
              } else if ("header" === n) {
                ...
                ("" === a && "" === r) ||
                  ((u +=
                    '<div class="' +
                    (t[s.class] ? f(t[s.class]) : c.header) +
                    '">'),
                  "" !== r &&
                    (u +=
                      '<i class="' +
        ...
        label: function (e, t, n, i) {
          return (
            (0, ee.fn.dropdown.settings.templates.escape)(t, n) +
            '<i class="' +
            i.delete +
            ' icon"></i>'
          );
            ...
            (s = {
              ...
              generate: {
                ...
                parameters: function (e, t) {
                  var n =
                    o[e] && o[e].parameters !== S ? o[e].parameters(i) : {};
                  return (
        ...
        return (
          e.each(function () {
            var o,
              ...
              u,
              d = V.isPlainObject(D)
                ? V.extend(!0, {}, V.fn.modal.settings, D)
                : V.extend({}, V.fn.modal.settings),
              f = d.selector,
              m = d.className,
              g = d.namespace,
              p = d.error,
            ...
            (u = {
              initialize: function () {
                (u.cache = {}),
                  ...
                  d.centered || b.addClass("top aligned"),
                  u.refreshModals(),
                  u.bind.events(),
              ...
              attachEvents: function (e, t) {
                var n = V(e);
                (t = V.isFunction(u[t]) ? u[t] : u.toggle),
                  0 < n.length
              ...
              bind: {
                events: function () {
                  u.verbose("Attaching events"),
                    ...
                    E.on("resize" + t, u.event.resize);
                },
                scrollLock: function () {
                  i.get(0).addEventListener(
                    "touchmove",
                    u.event.preventScroll,
                    { passive: !1 }
                  );
                },
              },
                ...
                mousedown: function (e) {
                  ...
                  (r = 0 < t.closest(f.modal).length) &&
                    ...
                    (s =
                      u.is.scrolling() &&
                      ((!n &&
                        V(z).outerWidth() - d.scrollbarWidth <= e.clientX) ||
                  ...
                  if (d.closable)
                    if (r)
                      ...
                      if (!t && n && u.is.active() && b.hasClass(m.front)) {
                        if (
                          (u.debug("Dimmer clicked, hiding all modals"),
                          d.allowMultiple)
                        ) {
                          if (!u.hideAll()) return;
              ...
              hideModal: function (e, t, n) {
                ...
                if (
                  ...
                  !1 === d.onHide.call(C, V(this)))
                )
                  return (
                    u.verbose("Hide callback returned false cancelling hide"),
                    (k = !1)
                  );
                (u.is.animating() || u.is.active()) &&
                  (d.transition &&
              ...
              hideAll: function (n) {
                ...
                if (
                  ((n = V.isFunction(n) ? n : function () {}), 0 < e.length)
                ) {
                  u.debug("Hiding all visible modals");
                  var i = !0;
                  return (
                    V(e.get().reverse()).each(function (e, t) {
              ...
              add: {
                keyboardShortcuts: function () {
                  u.verbose("Adding keyboard shortcuts"),
                    F.on("keyup" + h, u.event.keyboard);
                },
              },
              save: {
                focus: function () {
                  0 < V(N.activeElement).closest(b).length ||
                    (e = V(N.activeElement).blur());
                },
                bodyMargin: function () {
                  T = P.css(
                    "margin-" + (u.can.leftBodyScrollbar() ? "left" : "right")
                  );
              ...
              restore: {
                ...
                bodyMargin: function () {
                  ...
                  P.css("margin-" + e, T),
                    P.find(f.bodyFixed.replace("right", e)).css(
                      "padding-" + e,
                      T
                    );
                },
              ...
              remove: {
                ...
                clickaway: function () {
                  d.detachable || b.off("mousedown" + t),
                    n.off("mousedown" + t),
                    n.off("mouseup" + t);
                },
                ...
                bodyStyle: function () {
                  "" === P.attr("style") &&
                    (u.verbose("Removing style attribute"),
                    P.removeAttr("style"));
                },
              ...
              cacheSizes: function () {
                ...
                (u.cache.pageHeight !== H && 0 === n) ||
                  (V.extend(u.cache, {
                    ...
                    contextHeight:
                      "body" == d.context ? V(z).height() : i.height(),
                  }),
              ...
              is: {
                ...
                edge: function () {
                  return (
                    u.cache.isEdge === H &&
                      (u.cache.isEdge = !!z.setImmediate && !u.is.ie()),
                    u.cache.isEdge
                  );
                },
                firefox: function () {
                  return (
                    u.cache.isFirefox === H &&
                      (u.cache.isFirefox = !!z.InstallTrigger),
                    u.cache.isFirefox
                  );
                },
                iframe: function () {
              ...
              set: {
                ...
                clickaway: function () {
                  d.detachable || b.on("mousedown" + t, u.event.mousedown),
                ...
                dimmerStyles: function () {
                  d.inverted
                    ? n.addClass(m.inverted)
                    : n.removeClass(m.inverted),
                    d.blurring
                      ? i.addClass(m.blurring)
                ...
                modalOffset: function () {
                  if (d.detachable)
                    ...
                    b.css({
                      top:
                        !b.hasClass("aligned") && e
                          ? V(N).scrollTop() +
                            (u.cache.contextHeight - u.cache.height) / 2
                          : !e || b.hasClass("top")
                          ? V(N).scrollTop() + d.padding
                          : V(N).scrollTop() +
                            (u.cache.contextHeight -
                              u.cache.height -
                              d.padding),
                      marginLeft: -u.cache.width / 2,
                    });
                ...
                screenHeight: function () {
                  u.can.fit()
                    ...
                    : b.hasClass("bottom") ||
                      ...
                      P.css("height", u.cache.height + 2 * d.padding));
                },
                active: function () {
                  b.addClass(m.active + " " + m.front),
                    a.filter("." + m.active).removeClass(m.front);
                },
                scrolling: function () {
                  i.addClass(m.scrolling),
                    b.addClass(m.scrolling),
                    u.unbind.scrollLock();
                },
                legacy: function () {
                  b.addClass(m.legacy);
              ...
              setting: function (e, t) {
                if ((u.debug("Changing setting", e, t), V.isPlainObject(e)))
                  V.extend(!0, d, e);
                else {
                  if (t === H) return d[e];
                    ...
                    V.each(i, function (e, t) {
                      ...
                      if (V.isPlainObject(r[n]) && e != o) r = r[n];
                        ...
                        if (!V.isPlainObject(r[t]) || e == o)
                          return r[t] !== H && (a = r[t]), !1;
                        r = r[t];
                      }
                    })),
                  V.isFunction(a) ? (n = a.apply(t, e)) : a !== H && (n = a),
                  Array.isArray(A)
                    ? A.push(n)
                    : A !== H
                    ? (A = [A, n])
              ...
              j
                ? (w === H && u.initialize(), u.invoke(I))
                : (w !== H && w.invoke("destroy"), u.initialize());
          }),
          A !== H ? A : this
        );
      }),
            ...
            (f = {
              ...
              observeChanges: function () {
                "MutationObserver" in q &&
                  ((e = new MutationObserver(f.event.documentChanged)).observe(
                    V,
              ...
              event: {
                start: function (e) {
                  ...
                  clearTimeout(f.showTimer),
                    (f.hideTimer = setTimeout(f.hide, e));
                },
                ...
                hideGracefully: function (e) {
                  ...
                  e && !i && n
                    ? (f.debug("Click occurred outside popup hiding popup"),
                      f.hide())
                ...
                e || n || t
                  ? (f.debug("Creating pop-up html"),
                    ...
                    (u = L("<div/>")
                      ...
                      .html(e)),
                    m.inline
                      ? (f.verbose("Inserting popup element inline", u),
                        u.insertAfter(v))
                      : (f.verbose("Appending popup element to body", u),
                        u.appendTo(s)),
                    f.refresh(),
                    f.set.variation(),
              ...
              get: {
                ...
                variation: function () {
                  return (
                    v.removeData(h.variation),
                    v.data(h.variation) || m.variation
                  );
                },
                popup: function () {
                  return u;
                ...
                calculations: function () {
                  ...
                  return (
                    ...
                    (s.target.margin.top = m.inline
                      ? parseInt(
                          q.getComputedStyle(n).getPropertyValue("margin-top"),
                          10
                        )
                      : 0),
                ...
                position: function (e, t) {
                  if (0 !== y.length && 0 !== u.length) {
                    ...
                    if (
                      ...
                      return (
                        f.debug("Popup target is hidden, no action taken"), !1
                      );
                    switch (
                      (m.inline &&
                    ...
                    if (
                      ...
                      if (
                        (f.debug("Position is outside viewport", e),
                        x < m.maxSearchDepth)
                      )
                        return (
                          x++,
              ...
              remove: {
                ...
                attempts: function () {
                  f.verbose("Resetting all searched positions"),
                    (x = 0),
                    (c = !1);
                },
              },
              bind: {
                events: function () {
                  f.debug("Binding popup events to module"),
                    ...
                    "hover" == m.on &&
                      v.on("touchstart" + a, f.event.touchstart),
                    f.get.startEvent() &&
                      v
              ...
              should: {
                centerArrow: function (e) {
                  return (
                    !f.is.basic() && e.target.width <= 2 * m.arrowPixelsFromEdge
                  );
                },
              },
              is: {
                ...
                rtl: function () {
                  return (
                    "rtl" === v.attr("dir") || "rtl" === v.css("direction")
                  );
                },
              },
              reset: function () {
        ...
        return (
          e.each(function () {
            ...
            (c = {
              ...
              instantiate: function () {
                c.verbose("Storing instance of progress", c),
                  (g = c),
                  u.data(a, c);
              },
              destroy: function () {
              ...
              decrement: function (e) {
                ...
                c.get.total()
                  ...
                  : ((n =
                      (t = c.get.percent()) - (e = e || c.get.randomValue())),
              ...
              get: {
                ...
                normalizedValue: function (e) {
                  if (e < 0)
                    return c.debug("Value cannot decrement below 0"), 0;
                  if (c.has.total()) {
                    if (e > c.total)
                      return (
                        c.debug("Value cannot increment above total", c.total),
                        c.total
                      );
                  } else if (100 < e)
                    return (
                      c.debug("Value cannot increment above 100 percent"), 100
                    );
                  return e;
                },
                updateInterval: function () {
                  return "auto" == s.updateInterval
                    ? s.duration
                    : s.updateInterval;
                },
              ...
              set: {
                barWidth: function (e) {
                  c.debug("set bar width with ", e),
                    (e = c.helper.forceArray(e));
                  var o = -1,
                    a = -1,
                    r = c.helper.sum(e),
                    s = d.length,
                  ...
                  if (i && o > c.total) c.error(l.sumExceedsTotal, o, c.total);
                    ...
                    var a =
                        0 < s.precision
                          ? s.precision
                          : i
                          ? c.helper.derivePrecision(
                              Math.min.apply(null, c.value),
                              c.total
                            )
                          : 0,
                      r = e.map(function (e) {
                        return 0 < a
                          ? Math.round(e * (10 * a)) / (10 * a)
                          : Math.round(e);
                      });
                    (c.percent = r),
                      t &&
                        ((c.value = r.map(function (e) {
                          return 0 < a
                            ? Math.round((e / 100) * c.total * (10 * a)) /
                                (10 * a)
                            : Math.round((e / 100) * c.total * 10) / 10;
                        })),
                        s.limitValues &&
                          (c.value = c.value.map(function (e) {
                ...
                error: function (e, t) {
                  (e = e || s.text.error),
                    ...
                    c.remove.warning(),
                    c.complete(t),
                    (e = s.onLabelUpdate("error", e, c.value, c.total)) &&
                      c.set.label(e),
                    c.bind.transitionEnd(function () {
              ...
              update: {
                ...
                progress: function (e) {
                  ...
                  var t = c.helper.forceArray(e).map(function (e) {
                    var t;
                    return (
                      !1 === (e = c.get.numericValue(e)) &&
                        c.error(l.nonNumeric, e),
                  ...
                  "string" == typeof i &&
                    ...
                    T.each(i, function (e, t) {
                      ...
                      if (T.isPlainObject(r[n]) && e != o) r = r[n];
                        ...
                        if (!T.isPlainObject(r[t]) || e == o)
                          return (
                            r[t] !== D ? (a = r[t]) : c.error(l.method, i), !1
                          );
                        r = r[t];
                      }
                    })),
        ...
        return (
          e.each(function () {
            var m,
              ...
              b,
              d = H.isPlainObject(P)
                ? H.extend(!0, {}, H.fn.slider.settings, P)
                : H.extend({}, H.fn.slider.settings),
              i = d.className,
              f = d.metadata,
              y = d.namespace,
              x = d.error,
            ...
            (b = {
              ...
              instantiate: function () {
                b.verbose("Storing instance of slider", b),
                  (E = b),
                  D.data(S, b);
              },
              destroy: function () {
                b.verbose("Destroying previous slider for", D),
              ...
              setup: {
                layout: function () {
                  D.attr("tabindex") === B && D.attr("tabindex", 0),
                    0 == D.find(".inner").length &&
                      D.append(
                ...
                labels: function () {
                  b.is.labeled() &&
                    (0 != (r = D.find(".labels:not(.auto)")).length
                      ? b.setup.customLabel()
                      : b.setup.autoLabel(),
                    d.showLabelTicks && D.addClass(i.ticked));
                },
                ...
                customLabel: function () {
                  ...
                  e.each(function (e) {
                    ...
                    (n = t
                      ...
                      : (e + 1) / (i + 1)),
                      b.update.labelPosition(n, H(this));
                  });
                },
                autoLabel: function () {
                  if (0 != b.get.step()) {
                    0 != (r = D.find(".labels")).length
                      ? r.empty()
                      : (r = D.append('<ul class="auto labels"></ul>').find(
                          ".labels"
                        ));
                    for (var e = 0, t = b.get.numLabels(); e <= t; e++) {
                      var n = b.get.label(e),
                        i =
                          "" !== n
                            ? e % b.get.gapRatio()
                              ? H('<li class="halftick label"></li>')
                              : H('<li class="label">' + n + "</li>")
                            : null,
                        o = e / t;
              ...
              bind: {
                events: function () {
                  b.bind.globalKeyboardEvents(),
                    ...
                    d.autoAdjustLabels && b.bind.windowEvents();
                },
                keyboardEvents: function () {
                  b.verbose("Binding keyboard events"),
                    D.on("keydown" + T, b.event.keydown);
                },
                ...
                mouseEvents: function () {
                  b.verbose("Binding mouse events"),
                    ...
                    D.on("mousedown" + T, b.event.down),
                    D.on("mouseenter" + T, function (e) {
                      k = !0;
                    }),
                ...
                slidingEvents: function () {
                  b.verbose(
                    ...
                    b.is.touch()
                      ? (H(U).on("touchmove" + T, b.event.move),
                        H(U).on("touchend" + T, b.event.up))
                      : (H(U).on("mousemove" + T, b.event.move),
                        H(U).on("mouseup" + T, b.event.up));
                },
              ...
              unbind: {
                events: function () {
                  D.find(".track, .thumb, .inner").off("mousedown" + T),
                    D.find(".track, .thumb, .inner").off("touchstart" + T),
                    D.off("mousedown" + T),
                    D.off("mouseenter" + T),
                    D.off("mouseleave" + T),
                    D.off("touchstart" + T),
                    D.off("keydown" + T),
                    D.off("focusout" + T),
                    H(U).off("keydown" + T + t, b.event.activateFocus),
                    R.off("resize" + T);
                },
                slidingEvents: function () {
                  b.is.touch()
                    ? (H(U).off("touchmove" + T), H(U).off("touchend" + T))
                    : (H(U).off("mousemove" + T), H(U).off("mouseup" + T));
                },
              },
              event: {
                down: function (e) {
                  if ((e.preventDefault(), b.is.range())) {
                    ...
                    m =
                      d.preventCrossover &&
                      b.is.range() &&
                      b.thumbVal === b.secondThumbVal
                        ? ((u = n), B)
                        : b.determine.closestThumb(n);
                  }
                ...
                move: function (e) {
                  ...
                  if (0 == b.get.step() || b.is.smooth()) {
                    ...
                    m.hasClass("second")
                      ...
                      (t = Math.abs(o - (a || 0))),
                      b.update.position(r),
                      d.onMove.call(A, t, o, a);
                  } else
                    b.update.value(t, function (e, t, n) {
                ...
                activateFocus: function (e) {
                  !b.is.focused() &&
                    ...
                    (e.preventDefault(), b.event.keydown(e, !0), D.focus());
                },
                resize: function (e) {
                  F != b.get.gapRatio() &&
                    (b.setup.labels(), (F = b.get.gapRatio()));
                },
              },
              resync: function () {
                b.verbose("Resyncing thumb position based on value"),
                  b.is.range() && b.update.position(b.secondThumbVal, l),
                  b.update.position(b.thumbVal, s),
                  b.setup.labels();
              },
              takeStep: function (e) {
                e = e != B ? e : 1;
              ...
              backStep: function (e) {
                ...
                var t = b.get.step(),
                  n = b.get.currentThumbValue();
                if ((b.verbose("Going back a step"), 0 < t))
                  b.set.value(n - t * e);
                else if (0 == t) {
                  var i = b.get.precision(),
                    o = n - e / i;
              ...
              get: {
                ...
                numLabels: function () {
                  var e = Math.round(
                    (b.get.max() - b.get.min()) / b.get.step()
                  );
                  return (
                    b.debug("Determined that there should be " + e + " labels"),
                    e
                  );
                },
                labelType: function () {
                ...
                label: function (e) {
                  ...
                  switch (d.labelType) {
                    case d.labelTypes.number:
                      return (
                        Math.round((e * b.get.step() + b.get.min()) * c) / c
                      );
              ...
              determine: {
                ...
                closestThumb: function (e) {
                  var t = parseFloat(b.determine.thumbPos(s)),
                    ...
                    o = Math.abs(e - i);
                  return n === o && b.get.thumbValue() === b.get.min()
                    ? l
                    : n <= o
                    ? s
                    : l;
                ...
                positionFromValue: function (e) {
                  ...
                  return (
                    b.verbose(
                      "Determined position: " + a + " from value: " + e
                    ),
                    a
                  );
                },
                ...
                valueFromEvent: function (e) {
                  var t = b.determine.eventPos(e),
                    n = b.determine.pos(t);
                  return t < b.get.trackOffset()
                    ? b.is.reversed()
                      ? b.get.max()
                      : b.get.min()
                    : t > b.get.trackOffset() + b.get.trackLength()
                    ? b.is.reversed()
                      ? b.get.min()
                      : b.get.max()
                    : b.determine.value(n);
              ...
              handleNewValuePosition: function (e) {
                ...
                return (
                  e <= t ? (e = t) : n <= e && (e = n),
                  b.determine.positionFromValue(e)
                );
              },
              set: {
                value: function (e) {
                  b.update.value(e, function (e, t, n) {
                    (a && !d.fireOnInit) ||
                      (d.onChange.call(A, e, t, n), d.onMove.call(A, e, t, n));
                  });
                },
                rangeValue: function (e, t) {
                  if (b.is.range()) {
                    ...
                    e <= n ? (e = n) : i <= e && (e = i),
                      ...
                      (b.thumbVal = e),
                      (b.secondThumbVal = t),
                      (o = Math.abs(b.thumbVal - b.secondThumbVal)),
                      b.update.position(b.thumbVal, s),
                      b.update.position(b.secondThumbVal, l),
                      (a && !d.fireOnInit) ||
                        (d.onChange.call(A, o, b.thumbVal, b.secondThumbVal),
                        d.onMove.call(A, o, b.thumbVal, b.secondThumbVal));
                ...
                position: function (e, t) {
                  ...
                  (o = Math.abs(b.thumbVal - (b.secondThumbVal || 0))),
                    b.set.value(o);
                },
              },
              update: {
                value: function (e, t) {
                  ...
                  e <= n ? (e = n) : i <= e && (e = i),
                    b.is.range()
                      ? (m === B &&
                          (m = e <= b.get.currentThumbValue() ? s : l),
                        m.hasClass("second")
                          ? (d.preventCrossover &&
                              b.is.range() &&
                              (e = Math.max(b.thumbVal, e)),
                            (b.secondThumbVal = e))
                          : (d.preventCrossover &&
                              b.is.range() &&
                              (e = Math.min(b.secondThumbVal, e)),
                            (b.thumbVal = e)),
                        (o = Math.abs(b.thumbVal - b.secondThumbVal)))
                      : ((o = e), (b.thumbVal = o)),
                    b.update.position(e),
                    b.debug("Setting slider value to " + o),
                    "function" == typeof t &&
                      t(o, b.thumbVal, b.secondThumbVal);
                },
                position: function (e, t) {
                  ...
                  !1 !== d.start &&
                    (b.is.range()
                      ? (b.debug(
                        ...
                        b.set.rangeValue(d.start, d.end))
                      : (b.debug("Start position set from settings", d.start),
                        b.set.value(d.start)));
                },
              },
              setting: function (e, t) {
                if ((b.debug("Changing setting", e, t), H.isPlainObject(e)))
                  H.extend(!0, d, e);
                else {
                  if (t === B) return d[e];
                  ...
                  "string" == typeof i &&
                    ...
                    H.each(i, function (e, t) {
                      ...
                      if (H.isPlainObject(r[n]) && e != o) r = r[n];
                        ...
                        if (r[n] !== B) return (a = r[n]), !1;
                        if (!H.isPlainObject(r[t]) || e == o)
                          return (
                            r[t] !== B ? (a = r[t]) : b.error(x.method, i), !1
                          );
                        r = r[t];
                      }
                    })),
                  H.isFunction(a) ? (n = a.apply(t, e)) : a !== B && (n = a),
                  H.isArray(O)
                    ? O.push(n)
                    : O !== B
                    ? (O = [O, n])
              ...
              q
                ? (E === B && b.initialize(), b.invoke(L))
                : (E !== B && E.invoke("destroy"), b.initialize());
          }),
          O !== B ? O : this
        );
      }),
            ...
            (a = {
              ...
              setup: {
                layout: function () {
                  ...
                  a.debug("Generating icon html dynamically"),
                    f.html(n),
                    a.refresh();
                },
              },
              event: {
                ...
                click: function () {
                  var e = k(this),
                    t = a.get.rating(),
                    n = m.index(e) + 1;
                  ("auto" == r.clearable ? 1 === m.length : r.clearable) &&
                  t == n
                    ? a.clearRating()
                    : a.set.rating(n);
                },
      ...
      (F.fn.search = function (x) {
        ...
        return (
          F(this).each(function () {
            var f,
              u = F.isPlainObject(x)
                ? F.extend(!0, {}, F.fn.search.settings, x)
            ...
            (f = {
              ...
              event: {
                ...
                result: {
                  ...
                  click: function (e) {
                    ...
                    if (
                      (r && f.set.value(r),
                      F.isFunction(u.onSelect) &&
                        !1 === u.onSelect.call(v, l, s))
                    )
                      return (
                        f.debug(
              ...
              ensureVisible: function (e) {
                ...
                (n = (t = e.position().top) + e.outerHeight(!0)),
                  (i = r.scrollTop()),
                  (o = r.height()),
                  parseInt(r.css("paddingTop"), 0),
                  parseInt(r.css("paddingBottom"), 0),
                  t < 0
                    ? r.scrollTop(i + t)
                    : o < n && r.scrollTop(i + (n - o));
              },
              ...
              get: {
                settings: function () {
                  F.isPlainObject(x) &&
                    ...
                    f.error(u.error.oldSearchSyntax, v)),
                    u.ignoreDiacritics &&
                      !String.prototype.normalize &&
              ...
              create: {
                ...
                results: function () {
                  0 === r.length &&
                    (r = F("<div />").addClass(m.results).appendTo(p));
                },
              },
              inject: {
              ...
              generateResults: function (e) {
                ...
                var t = u.templates[u.type],
                  n =
                    F.isPlainObject(e[a.results]) &&
                    !F.isEmptyObject(e[a.results]),
                ...
                t[n.results] !== R &&
                  ...
                  F.each(t.results, function (e, t) {
                    t[n.url]
                      ...
                      t[n.price] !== R &&
                        (o +=
                          '<div class="price">' + a(t[n.price], i) + "</div>"),
                      t[n.title] !== R &&
                        (o +=
                          '<div class="title">' + a(t[n.title], i) + "</div>"),
                      t[n.description] !== R &&
                        (o +=
          ...
          x.each(function () {
            ...
            if (
              ((r = {
                ...
                destroy: function () {
                  r.verbose("Destroying previous module for", p),
                    d.removeData(u).off(a);
                },
                refresh: function () {
                ...
                set: {
                  defaultSide: function () {
                    (i = m.filter("." + s.className.active)),
                      (o =
                        0 < i.next(l.side).length ? i.next(l.side) : m.first()),
                      (g = !1),
                  ...
                  duration: function (e) {
                    (e =
                      "number" == typeof (e = e || s.duration) ? e + "ms" : e),
          ...
          e.each(function () {
            ...
            (c = {
              ...
              event: {
                ...
                scroll: function (e) {
                  0 === M(e.target).closest(n.sidebar).length &&
                    e.preventDefault();
                },
              },
              bind: {
              ...
              show: function (e) {
                if (
                  ((e = M.isFunction(e) ? e : function () {}), c.is.hidden())
                ) {
                  if (
                    (c.refreshSidebars(),
                    u.overlay &&
                  ...
                  "string" == typeof i &&
                    ...
                    M.each(i, function (e, t) {
                      ...
                      if (M.isPlainObject(r[n]) && e != o) r = r[n];
                        ...
                        if (!M.isPlainObject(r[t]) || e == o)
                          return (
                            r[t] !== L ? (a = r[t]) : c.error(d.method, i), !1
                          );
                        r = r[t];
                      }
                    })),
            ...
            (d = {
              ...
              set: {
                ...
                containerSize: function () {
                  ...
                  "HTML" === e || "body" == e
                    ? d.determineContainer()
                    : Math.abs(t.outerHeight() - d.cache.context.height) >
                        f.jitter &&
                      (d.debug(
          ...
          d.each(function () {
            ...
            (b = {
              ...
              changeTab: function (d) {
                var f =
                    O.history && O.history.pushState && x.ignoreFirstLoad && S,
                  ...
                  "string" == typeof i &&
                    ...
                    P.each(i, function (e, t) {
                      ...
                      if (P.isPlainObject(r[n]) && e != o) r = r[n];
                        ...
                        if (!P.isPlainObject(r[t]) || e == o)
                          return (
                            r[t] !== M ? (a = r[t]) : b.error(k.method, i), !1
                          );
                        r = r[t];
                      }
                    })),
            ...
            (u = {
              ...
              create: {
                container: function () {
                  u.verbose("Creating container"),
                    v.append(
                      F("<div/>", { class: d.position + " " + f.container })
                    );
                },
                toast: function () {
                  if (((i = F("<div/>", { class: f.box })), b))
                    ...
                    var e = F("<div/>", { class: f.content }),
                      t = u.get.iconClass();
                    "" !== t &&
                      o.append(F("<i/>", { class: t + " " + f.icon })),
                      d.showImage &&
                        o.append(
                          F("<img>", {
                      ...
                      "" !== d.title &&
                        e.append(
                          F("<div/>", { class: f.title, text: d.title })
                        ),
                      e.append(
                        F("<div/>", {
                      ...
                      o.addClass(d.class + " " + f.toast).append(e),
                  ...
                  if (
                    ...
                    u.has.configActions() &&
                      ...
                      o.hasClass("card") &&
                        ...
                        a.hasClass(f.vertical) &&
                          (a.removeClass(f.vertical), u.error(m.verticalCard))),
                      d.actions.forEach(function (e) {
                        var t = e[g.icon]
                            ? '<i class="' +
                              u.helpers.deQuote(e[g.icon]) +
                              ' icon"></i>'
                            : "",
                          n = u.helpers.escape(e[g.text] || "", d.preserveHTML),
                          i = u.helpers.deQuote(e[g.class] || ""),
                          o =
                            e[g.click] && F.isFunction(e[g.click])
                              ? e[g.click]
                              : function () {};
                        a.append(
                          F("<button/>", {
                    ...
                    var n =
                      f.progressing + " " + (d.pauseOnHover ? f.pausable : "");
                    d.showProgress &&
                      ((r = F("<div/>", {
                ...
                events: function () {
                  u.debug("Binding events to toast"),
                    (d.closeOnClick || d.closeIcon) &&
                      (d.closeIcon ? c : o).on("click" + n, u.event.click),
                    l && l.on("animationend" + n, u.close),
                    i
                      .on("click" + n, e.approve, u.event.approve)
                      .on("click" + n, e.deny, u.event.deny);
                },
              },
              unbind: {
                events: function () {
                  u.debug("Unbinding events to toast"),
                    (d.closeOnClick || d.closeIcon) &&
                      (d.closeIcon ? c : o).off("click" + n),
                    l && l.off("animationend" + n),
                    i.off("click" + n);
                },
              },
              animate: {
              ...
              has: {
                container: function () {
                  return (
                    ...
                    0 <
                      v.find(u.helpers.toClass(d.position) + e.container).length
                  );
                },
                toast: function () {
                  return !!u.get.toast();
              ...
              event: {
                ...
                deny: function () {
                  !1 !== d.onDeny.call(y, h)
                    ? u.close()
                    : u.verbose(
                        "Deny callback returned false cancelling close"
                      );
                },
              },
              helpers: {
              ...
              can: {
                useElement: function (e) {
                  return (
                    F.fn[e] !== P ||
                    (u.error(m.noElement.replace("{element}", e)), !1)
                  );
                },
              },
              setting: function (e, t) {
                  ...
                  "string" == typeof i &&
                    ...
                    F.each(i, function (e, t) {
                      ...
                      if (F.isPlainObject(r[n]) && e != o) r = r[n];
                        ...
                        if (!F.isPlainObject(r[t]) || e == o)
                          return (
                            r[t] !== P ? (a = r[t]) : u.error(m.method, i), !1
                          );
                        r = r[t];
                      }
                    })),
            ...
            (f = {
              ...
              get: {
                ...
                currentAnimation: function () {
                  return (
                    !(!f.cache || f.cache.animation === k) && f.cache.animation
                  );
                },
              ...
              (l = {
                ...
                query: function () {
                  if (l.is.disabled())
                    ...
                    if (
                      (c.defaultData &&
                        E.extend(!0, c.urlData, l.get.defaultData()),
                      ...
                      E.each(i, function (e, t) {
                        ...
                        if (E.isPlainObject(r[n]) && e != o) r = r[n];
                          ...
                          if (!E.isPlainObject(r[t]) || e == o)
                            return (
                              r[t] !== P ? (a = r[t]) : l.error(u.method, i), !1
                            );
                          r = r[t];
                        }
                      })),
        ...
        return (
          p.each(function () {
            ...
            (s = {
              ...
              destroy: function () {
                s.verbose("Destroying previous module", f),
                  u.off(r).removeData(c);
              },
              refresh: function () {
              ...
              add: {
                defaults: function () {
                  ...
                  w.each(o.defaults, function (e, t) {
                    s.is[e] !== k &&
                      s.is[e]() &&
                      (s.verbose("Adding default states", e, d),
              ...
              get: {
                text: function () {
                  return o.selector.text
                    ? u.find(o.selector.text).text()
                    : u.html();
                },
                textFor: function (e) {
                  return a[e] || !1;
              ...
              reset: {
                text: function () {
                  ...
                  s.is.textEnabled() &&
                    (s.is.active() && e
                      ? (s.verbose("Resetting active text", e),
                        s.update.text(e))
                      : t &&
                        (s.verbose("Resetting inactive text", e),
                        s.update.text(t)));
                },
              },
              update: {
                    ...
                    w.each(i, function (e, t) {
                      ...
                      if (w.isPlainObject(r[n]) && e != o) r = r[n];
                        ...
                        if (!w.isPlainObject(r[t]) || e == o)
                          return (
                            r[t] !== k ? (a = r[t]) : s.error(l.method, i), !1
                          );
                        r = r[t];
                      }
                    })),
