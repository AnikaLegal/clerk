...
LAWYER_GROUPS = [CaseGroups.ADMIN, CaseGroups.COORDINATOR, CaseGroups.LAWYER]
PARALEGAL_GROUPS = [
    CaseGroups.ADMIN,
...
def annotate_group_access(user):
    ...
    _is_lawyer_or_better = any([g in LAWYER_GROUPS for g in group_names])
    ...
    user.is_lawyer_or_better = _is_superuser or _is_lawyer_or_better
