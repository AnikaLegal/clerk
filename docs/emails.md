...
```
just ngrok https://90c8-194-193-130-131.ngrok.io
```
...
Dev emails can be sent to the subdomain `mail.dev.anikalegal.org.au`. Check the case email tab in the Clerk web UI to get a test email.
